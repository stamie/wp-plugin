...
// echo $queryDestinations;
   ...
   $rowsDestination = (is_array($rowsDestination) && count($rowsDestination) > 0)?$rowsDestination[0]:null;
    ...
    $return.= '<button class="all-boatLength down">Összes megjelenítése</button><button class="all-boatLength up hidden">Összes elrejtése</button><ol class="tree dest-boatLength">';
    ...
    //lefelé megy
    $edit = '<button type="button" class="dest-lengthSettings button" attr-dest="'.$rowsDestination->ID.'" attr-prefix="'.$prefix_id.'" attr-xml="'.$xml_id.'"><span class="dashicons dashicons-edit"> </span></button>';
    ...
    if ($bool){ // van gyereke
        ...
        $return .= $li.$button.$edit.$data.lengthSettings($parentId, $xml_id).'<ol>'; 
        ...
        if (++$index==1){ 
           ...
           // $return .= 'hello';
            $return .= $li.$edit.$data.lengthSettings($rowsDestination2->ID, $xml_id);
...
<div class="acordion-panel">
    <button class="help accordion help-dest-length"> </button>
    <div class="panel"><div class="helper-background">
    <h1 ><span >Dest.-ök &eacute;s haj&oacute;hossz adatok megad&aacute;sa</span></h1><p ><span ></span></p><ol start="1"><li ><span >Haj&oacute;hossz kiv&aacute;laszt&aacute;sa/m&oacute;dos&iacute;t&aacute;sa a desztin&aacute;ci&oacute;hoz &eacute;s annak alkateg&oacute;ri&aacute;ihoz t&ouml;megesen.<br></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 24.00px; height: 25.00px;"><img alt="" src="/wp-content/plugins/boat-shortcodes/admin/images/image5.png" style="width: 24.00px; height: 25.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></li></ol><p class="c8 c10"><span ></span></p><ol class="c3 lst-kix_list_5-0" start="2"><li ><span >Haj&oacute;hossz(ok) kiv&aacute;laszt&aacute;sa/m&oacute;dos&iacute;t&aacute;sa a felugr&oacute; ablakban.<br></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 484.00px; height: 29.00px;"><img alt="" src="/wp-content/plugins/boat-shortcodes/admin/images/image6.png" style="width: 484.00px; height: 29.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></li><li ><span >A desztin&aacute;ci&oacute;hoz &eacute;s annak alkateg&oacute;ri&aacute;ihoz az &ouml;sszes haj&oacute;hossz &eacute;rt&eacute;k (minimumt&oacute;l a maximumig) hozz&aacute; van rendelve.<br></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 17.00px; height: 21.00px;"><img alt="" src="/wp-content/plugins/boat-shortcodes/admin/images/image2.png" style="width: 17.00px; height: 21.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></li><li ><span >A desztin&aacute;ci&oacute; egyik alkateg&oacute;ri&aacute;j&aacute;hoz egyedi haj&oacute;hossz &eacute;rt&eacute;k van rendelve.<br></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 15.00px; height: 21.00px;"><img alt="" src="/wp-content/plugins/boat-shortcodes/admin/images/image3.png" style="width: 15.00px; height: 21.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></li><li class="c7 li-bullet-0"><span >A desztin&aacute;ci&oacute;hoz egyedi haj&oacute;hossz &eacute;rt&eacute;k van rendelve.<br></span><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 16.00px; height: 20.00px;"><img alt="" src="/wp-content/plugins/boat-shortcodes/admin/images/image4.png" style="width: 16.00px; height: 20.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></li></ol><hr style="page-break-before:always;display:none;"><p ><span ></span></p>
    </div>
    </div>
    ...
    <?= $return; ?>
<script>
    var acc = document.getElementsByClassName("help-dest-length");
    var i;
  ...
  acc[i].addEventListener("click", function() {
    ...
    jQuery('.dest-lengthSettings.button').on('click', function (event) {
        ...
        var url = "/wp-content/plugins/boat-shortcodes/admin/ajaxSubmitBoatLengthForDest.php";
    ...
    //Összes Lenyitása
    jQuery("button.all-boatLength.down").on('click',function(){
        var childrenLi     = jQuery('ol.tree.dest-boatLength').find('li');
        var childrenButton = jQuery('button.all-boatLength.up');
    ...
    jQuery("button.all-boatLength.up").on('click',function(){
        var childrenLi     = jQuery('ol.tree.dest-boatLength').children('li');
        var childrenButton = jQuery('button.all-boatLength.down');
