    ...
    return this.each(function() {
      ...
      var methods = {
        init : function() {
          ...
          _options = jQuery.extend(_defaults, method);

          currentID = new Date().getMilliseconds();
          waitMeObj = jQuery('<div class="' + elemClass + '" data-waitme_id="' + currentID + '"></div>');
          ...
          switch (_options.effect) {
            ...
            case 'timer':
              effectElemCount = 2;
							if (jQuery.isArray(_options.color)) {
          ...
          if (effectElemCount > 0) {
            ...
            effectObj = jQuery('<div class="' + elemClass + '_progress ' + _options.effect + '" style="' + addStyle + '">' + effectElemHTML + '</div>');
          }
          ...
          if (_options.text) {
            ...
            waitMe_text = jQuery('<div class="' + elemClass + '_text" style="color:' + color + ';' + size + '">' + _options.text + '</div>');
          }
          ...
          var waitMeDivObj = jQuery('<div class="' + elemClass + '_content ' + _options.textPos + '"></div>');
          ...
          if (elem.outerHeight() > jQuery(window).height()) {
            var sTop = jQuery(window).scrollTop(),
            elH = elemContentObj.outerHeight(),
            elTop = elem.offset().top,
            cH = elem.outerHeight(),
						getTop = sTop - elTop + jQuery(window).height()/2;
						if (getTop < 0) {
							getTop = Math.abs(getTop);
						}
						if (getTop - elH >= 0 && getTop + elH <= cH) {
							if (elTop - sTop > jQuery(window).height()/2) {
								getTop = elH;
							}
							setElTop(getTop);
						} else {
