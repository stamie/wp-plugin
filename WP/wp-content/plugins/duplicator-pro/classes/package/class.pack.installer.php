...
class DUP_PRO_Installer
{
    ...
    {
        //Since folders are not being indexed we have to validate files in those folder to validate the folder
        return array(
            $this->getInstallerBackupName(),
            'dup-installer/'.DUPLICATOR_PRO_ORIG_FOLDER_PREFIX.$this->Package->get_package_hash().'/.htaccess',
            ...
            'dup-installer/lib/snaplib/index.php',
            'dup-installer/index.php',
