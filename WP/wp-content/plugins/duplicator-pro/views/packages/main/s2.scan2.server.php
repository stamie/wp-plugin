...
<div class="scan-item">
	...
	<div class="info">
        ...
        echo '<small>';
        printf(DUP_PRO_U::__('Issues might occur for larger packages when the [memory_limit] value in the php.ini is too low.  The minimum recommended memory limit is "%s" or higher. An attempt is made to override this value if the server allows it. To manually increase the memory limit have a look at this %s[FAQ item]%s'),
            DUPLICATOR_PRO_MIN_MEMORY_LIMIT, "<i><a href='https://snapcreek.com/duplicator/docs/faqs-tech/?210328131212#faq-trouble-056-q' target='_blank'>", "</a></i>");
        echo '</small>';
...
//MU Gold
else if ($is_mu && License::isBusiness()) {
