...
$storageTabURL = DupProSnapLibURLU::appendQueryValue(DUP_PRO_U::getMenuPageURL(DUP_PRO_Constants::$STORAGE_SUBMENU_SLUG, false), 'tab', 'storage');
$tempStorageEditURLWithOutStorageId = DupProSnapLibURLU::appendQueryValue($storageTabURL, 'inner_page', 'edit');
?>
<script>
            ...
            var $this = $(this),
                ...
                error = {
                    message: function (text) {
                        fix.append("&nbsp; <span style='color:#cc0000' id='" + toggle.replace('#', '') + "-error'><i class='fa fa-exclamation-triangle'></i>&nbsp; " + text + "</span>");
                    },
                    remove: function () {
                        if ($(toggle + "-error"))
                            $(toggle + "-error").remove();
...
<?php $alert5->showAlert(); ?>
                    ...
                    for (storage_provider_key in parsedData.storage_providers) {
                        ...
                        var storage_container_classes = ['dpro-dlg-remote-endpoint'];

                        if (store.failed) {
                            failed_string = " (<?php DUP_PRO_U::esc_html_e('failed'); ?>)";
                            storage_container_classes.push('dpro-dlg-remote-endpoint-failed');
                        }

                        if (store.cancelled) {
                            cancelled_string = " (<?php DUP_PRO_U::esc_html_e('cancelled'); ?>)";
                            storage_container_classes.push('dpro-dlg-remote-endpoint-cancelled');
                        }
                        ...
                        switch (parseInt(store.storage_type)) {
                            ...
                            case DupPro.Pack.StorageTypes.local:
                                if ((store.id != -2)) {
                                    info += "<div class='" + storage_container_classes.join(' ') + "'>";
                                    info += "<h4 class='dup-pro-storage-list-storage-name'><i class='fa fa-server'></i> <?php DUP_PRO_U::esc_html_e('Local Endpoint'); ?>: '" + store.name + failed_string + cancelled_string + "'</h4>";
                                    info += "<span class='dpro-dlg-remote-endpoints-links'>" + dupProTestConnLink + "</span>";
                                    info += "<span class='dup-pro-storage-list-storage-location'><?php DUP_PRO_U::esc_html_e('Location'); ?>: " + store.storage_location_string + "</span>";
                                    info += "</div>";
                                }
                                break;
                                //FTP
                            case DupPro.Pack.StorageTypes.ftp:
                                ...
                                info += "<div class='" + storage_container_classes.join(' ') + "'>";
                                info += "<h4 class='dup-pro-storage-list-storage-name'><i class='fa fa-cloud'></i> <?php DUP_PRO_U::esc_html_e('FTP Endpoint'); ?>: '" + store.name + failed_string + cancelled_string + "'</h4>";
                                info += "<span class='dpro-dlg-remote-endpoints-links'>" + dupProTestConnLink + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-server'>Server: " + store.ftp_server + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-location'>Location: " + ftp_url + "</span>";
                                info += "</div>";
                                break;
                                //SFTP
                            case DupPro.Pack.StorageTypes.sftp:
                                ...
                                info += "<div class='" + storage_container_classes.join(' ') + "'>";
                                info += "<h4 class='dup-pro-storage-list-storage-name'><i class='fa fa-cloud'></i> SFTP Endpoint: '" + store.name + failed_string + cancelled_string + "'</h4>";
                                info += "<span class='dpro-dlg-remote-endpoints-links'>" + dupProTestConnLink + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-server'>Server: " + store.sftp_server + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-location'>Location: " + sftp_url + "</span>";
                                info += "</div>";
                                break;
                                //DROPBOX
                            case DupPro.Pack.StorageTypes.dropbox:
                                ...
                                info += "<div class='" + storage_container_classes.join(' ') + "'>";
                                info += "<h4 class='dup-pro-storage-list-storage-name'><i class='fab fa-dropbox fa-lg'></i> <?php DUP_PRO_U::esc_html_e('Dropbox Endpoint'); ?>: '" + store.name + failed_string + cancelled_string + "'</h4>";
                                info += "<span class='dpro-dlg-remote-endpoints-links'>" + dupProTestConnLink + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-location'>Location: " + dbox_url + "</span>";
                                info += "</div>";
                                break;
                                //GDRIVE
                            case DupPro.Pack.StorageTypes.gdrive:
                                ...
                                info += "<div class='" + storage_container_classes.join(' ') + "'>";
                                info += "<h4 class='dup-pro-storage-list-storage-name'><i class='fa fa-cloud'></i> <?php DUP_PRO_U::esc_html_e('Google Drive Endpoint'); ?>: '" + store.name + failed_string + cancelled_string + "'</h4>";
                                info += "<span class='dpro-dlg-remote-endpoints-links'>" + dupProTestConnLink + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-location'>Location: " + gdrive_url + "</span>";
                                info += "</div>";
                                break;
                                //S3
                            case DupPro.Pack.StorageTypes.s3:
                                info += "<div class='" + storage_container_classes.join(' ') + "'>";
                                info += "<h4 class='dup-pro-storage-list-storage-name'><i class='fa fa-cloud'></i> <?php DUP_PRO_U::esc_html_e('Amazon S3 Endpoint'); ?>: '" + store.name + failed_string + cancelled_string + "'</h4>";
                                info += "<span class='dpro-dlg-remote-endpoints-links'>" + dupProTestConnLink + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-location'>Location: " + store.storage_location_string + "</span>";
                                info += "</div>";
                                break;
                                //ONEDRIVE
                            ...
                            case DupPro.Pack.StorageTypes.onedrivemsgraph:
                                info += "<div class='" + storage_container_classes.join(' ') + "'>";
                                info += "<h4 class='dup-pro-storage-list-storage-name'><i class='fa fa-cloud'></i> <?php DUP_PRO_U::esc_html_e('OneDrive Endpoint'); ?>: '" + store.name + failed_string + cancelled_string + "'</h4>";
                                info += "<span class='dpro-dlg-remote-endpoints-links'>" + dupProTestConnLink + "</span>";
                                info += "<span class='dup-pro-storage-list-storage-location'>Location: " + store.storage_location_string + "</span>";
                                info += "</div>";
                                break;
                    ...
                    info += '</div>';
                    info += "<a href='" + parsedData.logURL + "' class='dpro-dlg-remote-endpoint-log-link' target='_blank'>" + '<?php echo DUP_PRO_U::__('[Package Build Log]');?>' + "</a>";
