...
<div class="dup-pro-import-header" >
    <h2 class="title">
        ...
        <sup><i class="fas fa-question-circle fa-sm" data-tooltip-title="<?php DUP_PRO_U::esc_html_e('Upload Archive:')?>" data-tooltip="<?php DUP_PRO_U::esc_html_e('Upload a Duplicator Pro archive to overwrite the current site with the contents of the archive.');?>" aria-expanded="false"></i></sup>
    </h2>
    <div class="options" >
