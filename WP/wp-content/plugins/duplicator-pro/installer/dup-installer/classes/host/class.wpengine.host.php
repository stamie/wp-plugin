...
class DUPX_WPEngine_Host implements DUPX_Host_interface
{
    ...
    public function isHosting()
    {
        ...
        $file = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_MUPLUGINS_NEW).'/wpengine-security-auditor.php';
    ...
    {
        DUPX_Params_Manager::getInstance()->setValue(DUPX_Params_Manager::PARAM_IGNORE_PLUGINS, array(
            'mu-plugin.php',
            'advanced-cache.php',
    ...
    {
        $fdPlugins = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_FORCE_DIABLE_PLUGINS);
        ...
        DUPX_Params_Manager::getInstance()->setValue(DUPX_Params_Manager::PARAM_FORCE_DIABLE_PLUGINS, $fdPlugins);
    }
}