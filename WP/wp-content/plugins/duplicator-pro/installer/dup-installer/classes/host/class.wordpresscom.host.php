...
class DUPX_WordpressCom_Host implements DUPX_Host_interface
{
    ...
    public function isHosting()
    {
        ...
        $testFile = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_MUPLUGINS_NEW).'/wpcomsh-loader.php';
    ...
    public function setCustomParams()
    {
        ...
        if (!DUPX_InstallerState::isRecoveryMode() && !empty($overwriteData['adminUsers'])) {
            ...
            $paramsManager->setValue(DUPX_Params_Manager::PARAM_KEEP_TARGET_SITE_USERS, $keepUserId);
        }
    }
}