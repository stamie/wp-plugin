...
class DUPX_DB_Functions
{
    ...
    public function dbConnection($customConnection = null)
    {
        if (is_null($this->dbh)) {
            if (is_null($customConnection)) {
                ...
                $dbname = $paramsManager->getValue(DUPX_Params_Manager::PARAM_DB_NAME);
            ...
            if (is_null($customConnection)) {
                ...
                DUPX_DB::setCharset($this->dbh, $paramsManager->getValue(DUPX_Params_Manager::PARAM_DB_CHARSET), $paramsManager->getValue(DUPX_Params_Manager::PARAM_DB_COLLATE));
            }
        }
        return $this->dbh;
    }
    ...
    public function getRealCharsetByParam()
    {
        ...
        $sourceCharset = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_DB_CHARSET);
    ...
    public function getRealCollateByParam()
    {
        ...
        $sourceCollate = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_DB_COLLATE);
    ...
    {
        if (is_null($prefix)) {
            $prefix = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_DB_TABLE_PREFIX);
        }
    ...
    public function pregReplaceTableName($pattern, $replacement, $options = array())
    {
        ...
        $escapedDbName = mysqli_real_escape_string($this->dbh, DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_DB_NAME));
    ...
    public function updatePostsAuthor($userId, $prefix = null)
    {
        ...
        DUPX_Log::info('EXECUTE QUERY '.$sql);
        if (($result     = DUPX_DB::mysqli_query($this->dbh, $sql)) === false) {
            return false;
        }
