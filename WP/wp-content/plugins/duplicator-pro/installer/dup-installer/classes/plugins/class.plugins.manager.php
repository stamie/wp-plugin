...
final class DUPX_Plugins_Manager
{
    ...
    public function preViewChecks()
    {
        ...
        $activePlugins = $paramsManager->getValue(DUPX_Params_Manager::PARAM_PLUGINS);
        $saveParams    = false;
    ...
    public function executeActions($dbh, $subsiteId = -1)
    {
        ...
        $removeInactivePlugins      = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_REMOVE_RENDUNDANT);
    ...
    public function setAutoActions($subsiteId = -1)
    {
        ...
        if ($paramManager->getValue(DUPX_Params_Manager::PARAM_SITE_URL_OLD) != $paramManager->getValue(DUPX_Params_Manager::PARAM_SITE_URL) &&
