...
class DUPX_test_wordpress_exec implements DUPX_interface_test
{
    ...
    {
        $indexPath = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_NEW).'/index.php';
        $data      = array(
    ...
    {
        $indexPath = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_WP_CORE_NEW).'/wp-login.php';
        $data      = array(
            DUPX_test_wordpress_exec::SCRIPT_NAME_HTTP_PARAM => $indexPath
        );
    ...
    public static function getScriptTestPath()
    {
        ...
        return DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_CONTENT_NEW).'/'.self::getScriptTestName();
    }

    public static function getScriptTestUrl()
    {
        // use wp-content path and not root path 
        return DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_URL_CONTENT_NEW).'/'.self::getScriptTestName();
    }
