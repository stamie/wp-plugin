 ...
 */
final class DUPX_Params_Descriptor_replace implements DUPX_Interface_Params_Descriptor
{
    ...
    {
        $params[DUPX_Params_Manager::PARAM_BLOGNAME] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_CUSTOM_SEARCH] = new DUPX_Param_item(
        ...
        $params[DUPX_Params_Manager::PARAM_CUSTOM_REPLACE] = new DUPX_Param_item(
        ...
        $params[DUPX_Params_Manager::PARAM_EMPTY_SCHEDULE_STORAGE] = new DUPX_Param_item_form(
            DUPX_Params_Manager::PARAM_EMPTY_SCHEDULE_STORAGE,
            DUPX_Param_item_form::TYPE_BOOL,
            DUPX_Param_item_form::FORM_TYPE_CHECKBOX,
            array(
            'default' => $params[DUPX_Params_Manager::PARAM_RESTORE_BACKUP_MODE]->getValue() ? false : true
            ),
            array(
            'label'         => 'Cleanup:',
        ...
        $params[DUPX_Params_Manager::PARAM_EMAIL_REPLACE] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_FULL_SEARCH] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_POSTGUID] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_MAX_SERIALIZE_CHECK] = new DUPX_Param_item_form(
    ...
    {
        if ($params[DUPX_Params_Manager::PARAM_BLOGNAME]->getStatus() !== DUPX_Param_item::STATUS_OVERWRITE) {
            $params[DUPX_Params_Manager::PARAM_BLOGNAME]->setValue(DUPX_ArchiveConfig::getInstance()->getBlognameFromSelectedSubsiteId());
        }
    }
}
