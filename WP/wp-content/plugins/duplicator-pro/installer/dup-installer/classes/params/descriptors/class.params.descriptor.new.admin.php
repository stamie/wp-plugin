 ...
 */
final class DUPX_Params_Descriptor_new_admin implements DUPX_Interface_Params_Descriptor
{
    ...
    {
        $params[DUPX_Params_Manager::PARAM_WP_ADMIN_CREATE_NEW] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_WP_ADMIN_NAME] = new DUPX_Param_item_form(
            ...
            'validateCallback' => function ($value) {
                if (DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_WP_ADMIN_CREATE_NEW)) {
        ...
        $params[DUPX_Params_Manager::PARAM_WP_ADMIN_PASSWORD] = new DUPX_Param_item_form_pass(
        ...
        $params[DUPX_Params_Manager::PARAM_WP_ADMIN_MAIL] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_WP_ADMIN_NICKNAME] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_WP_ADMIN_FIRST_NAME] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_WP_ADMIN_LAST_NAME] = new DUPX_Param_item_form(
