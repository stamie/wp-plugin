 ...
 */
final class DUPX_Params_Descriptor_generic implements DUPX_Interface_Params_Descriptor
{
    ...
    public static function init(&$params)
    {
        ...
        $params[DUPX_Params_Manager::PARAM_SECURE_PASS] = new DUPX_Param_item_form_pass(
            DUPX_Params_Manager::PARAM_SECURE_PASS,
        ...
        $params[DUPX_Params_Manager::PARAM_SECURE_OK] = new DUPX_Param_item(
            DUPX_Params_Manager::PARAM_SECURE_OK,
        ...
        $params[DUPX_Params_Manager::PARAM_FILE_PERMS_VALUE] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_SET_FILE_PERMS] = new DUPX_Param_item_form(
            ...
            'wrapperClasses' => array('display-inline-block'),
            'attr'           => array(
                'onclick' => "jQuery('#" . $params[DUPX_Params_Manager::PARAM_FILE_PERMS_VALUE]->getFormItemId() . "').prop('disabled', !jQuery(this).is(':checked'));"
            )
            )
        );

        $params[DUPX_Params_Manager::PARAM_DIR_PERMS_VALUE] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_SET_DIR_PERMS] = new DUPX_Param_item_form(
            ...
            'wrapperClasses' => array('display-inline-block'),
            'attr'           => array(
                'onclick' => "jQuery('#" . $params[DUPX_Params_Manager::PARAM_DIR_PERMS_VALUE]->getFormItemId() . "').prop('disabled', !jQuery(this).is(':checked'));"
            )
            )
        );

        $params[DUPX_Params_Manager::PARAM_SAFE_MODE] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_FILE_TIME] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_LOGGING] = new DUPX_Param_item_form(
            DUPX_Params_Manager::PARAM_LOGGING,
            DUPX_Param_item_form::TYPE_INT,
            DUPX_Param_item_form::FORM_TYPE_RADIO,
            array(
        ...
        $params[DUPX_Params_Manager::PARAM_REMOVE_RENDUNDANT] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_RECOVERY_LINK] = new DUPX_Param_item(
            DUPX_Params_Manager::PARAM_RECOVERY_LINK,
            DUPX_Param_item_form_pass::TYPE_STRING,
            array(
            'default' => ''
            )
        ...
        $params[DUPX_Params_Manager::PARAM_FROM_SITE_IMPORT_INFO] = new DUPX_Param_item(
            DUPX_Params_Manager::PARAM_FROM_SITE_IMPORT_INFO,
        ...
        $params[DUPX_Params_Manager::PARAM_AUTO_CLEAN_INSTALLER_FILES] = new DUPX_Param_item_form(
            DUPX_Params_Manager::PARAM_AUTO_CLEAN_INSTALLER_FILES,
            DUPX_Param_item_form::TYPE_BOOL,
            DUPX_Param_item_form::FORM_TYPE_CHECKBOX,
            array(
            'default' => true
