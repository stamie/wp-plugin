 ...
 */
final class DUPX_Params_Descriptor_cpanel implements DUPX_Interface_Params_Descriptor
{
    ...
    {
        $params[DUPX_Params_Manager::PARAM_CPNL_CAN_SELECTED] = new DUPX_Param_item(
            DUPX_Params_Manager::PARAM_CPNL_CAN_SELECTED,
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_HOST] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_USER] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_PASS] = new DUPX_Param_item_form_pass(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_ACTION] = $params[DUPX_Params_Manager::PARAM_DB_ACTION]->getCopyWithNewName(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_ACTION]->setOptionStatus(0, DUPX_Param_item_form_option::OPT_ENABLED);

        $params[DUPX_Params_Manager::PARAM_CPNL_PREFIX] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_HOST] = $params[DUPX_Params_Manager::PARAM_DB_HOST]->getCopyWithNewName(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_NAME_SEL] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_NAME_TXT] = $params[DUPX_Params_Manager::PARAM_DB_NAME]->getCopyWithNewName(
            ...
            array(
                ...
                'validateCallback' => function ($value) {
                    ...
                    if (
                        $paramManager->getValue(DUPX_Params_Manager::PARAM_DB_VIEW_MODE) === 'cpnl' &&
                        $paramManager->getValue(DUPX_Params_Manager::PARAM_CPNL_DB_ACTION) === DUPX_DBInstall::DBACTION_CREATE
                    ) {
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_USER_SEL] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_USER_TXT] = $params[DUPX_Params_Manager::PARAM_DB_USER]->getCopyWithNewName(
            ...
            array(
                ...
                'validateCallback' => function ($value) {
                    ...
                    if (
                        $paramManager->getValue(DUPX_Params_Manager::PARAM_DB_VIEW_MODE) === 'cpnl' &&
                        $paramManager->getValue(DUPX_Params_Manager::PARAM_CPNL_DB_USER_CHK) === true
                    ) {
                        return DUPX_Params_Descriptors::validateNotEmpty($value);
                    } else {
                        $value = '';
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_USER_CHK] = new DUPX_Param_item_form(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_DB_PASS] = $params[DUPX_Params_Manager::PARAM_DB_PASS]->getCopyWithNewName(
        ...
        $params[DUPX_Params_Manager::PARAM_CPNL_IGNORE_PREFIX] = new DUPX_Param_item_form(
    ...
    {
        if (DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_DB_VIEW_MODE) === 'cpnl') {
            return DUPX_Params_Descriptors::validateNotEmpty($value);
        } else {
            $value = '';
            return true;
