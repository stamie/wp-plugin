 ...
 */
final class DUPX_Params_Descriptor_validation implements DUPX_Interface_Params_Descriptor
{
    ...
    {
        $params[DUPX_Params_Manager::PARAM_VALIDATION_LEVEL] = new DUPX_Param_item(
            DUPX_Params_Manager::PARAM_VALIDATION_LEVEL,
        ...
        $params[DUPX_Params_Manager::PARAM_VALIDATION_ACTION_ON_START] = new DUPX_Param_item(
            DUPX_Params_Manager::PARAM_VALIDATION_ACTION_ON_START,
        ...
        $params[DUPX_Params_Manager::PARAM_VALIDATION_SHOW_ALL] = new DUPX_Param_item_form(
            DUPX_Params_Manager::PARAM_VALIDATION_SHOW_ALL,
        ...
        $params[DUPX_Params_Manager::PARAM_ACCEPT_TERM_COND] = new DUPX_Param_item_form(
