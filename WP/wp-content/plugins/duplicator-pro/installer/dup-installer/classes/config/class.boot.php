...
class DUPX_Boot
{
    ...
    public static function init()
    {
        ...
        self::initArchive();
        // init params
        DUPX_Params_Manager::getInstance()->initParams();
        ...
        if (DUPX_Log::isLevel(DUPX_Log::LV_DEBUG)) {
            ...
            DUPX_Log::info(DUPX_Params_Manager::getInstance()->getParamsToText());
            DUPX_Log::info('-------------------');
        }
    ...
    public static function includes()
    {
        ...
        require_once(DUPX_INIT . '/classes/config/class.license.php');
    ...
    protected static function initParamsBase()
    {
        ...
        $GLOBALS['DUPX_DEBUG'] = $paramsManager->getValue(DUPX_Params_Manager::PARAM_DEBUG);
    }
    ...
    public static function isInit()
    {
        ...
        $isFirstStep   = isset($_REQUEST[DUPX_Params_Manager::PARAM_CTRL_ACTION]) && $_REQUEST[DUPX_Params_Manager::PARAM_CTRL_ACTION] === "ctrl-step1";
        $isInitialized = isset($_REQUEST[DUPX_Params_Manager::PARAM_STEP_ACTION]) && !empty($_REQUEST[DUPX_Params_Manager::PARAM_STEP_ACTION]);
