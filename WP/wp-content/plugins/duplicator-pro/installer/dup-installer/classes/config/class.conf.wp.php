...
class DUPX_WPConfig
{
    ...
    {
        return DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_NEW).'/wp-config.php';
    }
    ...
    public static function getWpConfigPath()
    {
        ...
        if ($origWpDir === DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_NEW)) {
            return $origWpConfTarget;
        } else {
            return DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_PATH_WP_CORE_NEW)."/wp-config.php";
        }
    }
