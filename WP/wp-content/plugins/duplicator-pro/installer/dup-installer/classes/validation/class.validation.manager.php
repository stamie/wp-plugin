...
class DUPX_Validation_manager
{
    ...
    public static function isValidated()
    {
        ...
        return $paramsManager->getValue(DUPX_Params_Manager::PARAM_VALIDATION_LEVEL) >= self::MIN_LEVEL_VALID;
    }
    ...
    public static function isFirstValidationOnLoad()
    {
        return (
            DUPX_Boot::isInit() &&
            DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_VALIDATION_ACTION_ON_START) === DUPX_Validation_manager::ACTION_ON_START_AUTO
            );
    }
    ...
    {
        $paramsManager = DUPX_Params_Manager::getInstance();
        if ($paramsManager->getValue(DUPX_Params_Manager::PARAM_VALIDATION_ACTION_ON_START) === DUPX_Validation_manager::ACTION_ON_START_AUTO) {
            return true;
        }
        if ($paramsManager->getValue(DUPX_Params_Manager::PARAM_STEP_ACTION) === DUPX_CTRL::ACTION_STEP_ON_VALIDATE) {
            return true;
        }
        return false;
    }
    ...
    public function getValidateData()
    {
        ...
        $paramsManager = DUPX_Params_Manager::getInstance();
        $paramsManager->setValue(DUPX_Params_Manager::PARAM_VALIDATION_LEVEL, $mainResult);
        $paramsManager->save();
