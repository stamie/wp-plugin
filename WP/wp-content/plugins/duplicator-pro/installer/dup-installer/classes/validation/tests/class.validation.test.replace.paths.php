...
class DUPX_Validation_test_replace_paths extends DUPX_Validation_abstract_item
{
    ...
    protected function runTest()
    {
        ...
        if ($paramsManager->getValue(DUPX_Params_Manager::PARAM_REPLACE_ENGINE) === DUPX_S3_Funcs::MODE_SKIP ||
            $paramsManager->getValue(DUPX_Params_Manager::PARAM_SKIP_PATH_REPLACE) === false) {
            return self::LV_SKIP;
        }
        ...
        if (strlen($archivePaths->home) == 0) {
            ...
            if (strlen($paramsManager->getValue(DUPX_Params_Manager::PARAM_PATH_NEW)) === 0) {
                return self::LV_SKIP;
            }
