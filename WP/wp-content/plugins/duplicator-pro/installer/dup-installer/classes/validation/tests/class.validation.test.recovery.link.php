...
class DUPX_Validation_test_recovery extends DUPX_Validation_abstract_item
{
    ...
    protected function runTest()
    {
        ...
        $this->importSiteInfo      = DUPX_Params_Manager::getInstance()->getValue(DUPX_Params_Manager::PARAM_FROM_SITE_IMPORT_INFO);
        ...
        $recoveryLink = $paramsManager->getValue(DUPX_Params_Manager::PARAM_RECOVERY_LINK);
