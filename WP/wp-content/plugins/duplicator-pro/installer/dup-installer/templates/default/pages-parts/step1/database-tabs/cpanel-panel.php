...
<div id="s2-cpnl-area" >
    <?php
    $paramsManager->getHtmlFormParam(DUPX_Params_Manager::PARAM_CPNL_HOST);
    $paramsManager->getHtmlFormParam(DUPX_Params_Manager::PARAM_CPNL_USER);
    $paramsManager->getHtmlFormParam(DUPX_Params_Manager::PARAM_CPNL_PASS);
    ?>
