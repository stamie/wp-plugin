...
$cpnlCanSel = $paramsManager->getValue(DUPX_Params_Manager::PARAM_CPNL_CAN_SELECTED);

$cpnlDisplay  = 'no-display';
$basicDisplay = '';

if ($cpnlCanSel && $paramsManager->getValue(DUPX_Params_Manager::PARAM_DB_VIEW_MODE) === 'cpnl') {
    $cpnlDisplay  = '';
...
<div id="base-setup-area" class="hdr-sub1-area dupx-opts" >
    <?php 
    if ($cpnlCanSel) {
        $paramsManager->getHtmlFormParam(DUPX_Params_Manager::PARAM_DB_VIEW_MODE);
    }
    ?>
