...
<script>
    ...
    const cpnlHostInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_HOST)); ?>;
    const cpnlUserInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_USER)); ?>;
    const cpnlPassInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_PASS)); ?>;
    const cpnlDbHostInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_HOST)); ?>;
    const cpnlDbUserInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_USER_TXT)); ?>;
    const cpnlDbPassInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_PASS)); ?>;
    const cpnlDbActionInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_ACTION)); ?>;
    const cpnlDbNameWrapperId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormWrapperId(DUPX_Params_Manager::PARAM_CPNL_DB_NAME_TXT)); ?>;
    const cpnlDbNameInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_NAME_TXT)); ?>;
    const cpnlDbNameSelWrapperId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormWrapperId(DUPX_Params_Manager::PARAM_CPNL_DB_NAME_SEL)); ?>;
    const cpnlDbNameSelInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_NAME_SEL)); ?>;
    const cpnlPrefixInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_PREFIX)); ?>;
    const cpnlDbUserWrapperId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormWrapperId(DUPX_Params_Manager::PARAM_CPNL_DB_USER_TXT)); ?>;
    const cpnlDbUserSelWrapperId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormWrapperId(DUPX_Params_Manager::PARAM_CPNL_DB_USER_SEL)); ?>;
    const cpnlDbUserSelInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_USER_SEL)); ?>;
    const cpnlDbUserCheckInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_DB_USER_CHK)); ?>;
    const cpnlIgnorePrefixInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_CPNL_IGNORE_PREFIX)); ?>;
