...
?>
<script>
    const urlNewInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_URL_NEW)); ?>;
    const pathNewInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_PATH_NEW)); ?>;
    const exeSafeModeInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_SAFE_MODE)); ?>;
    const htConfigInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_HTACCESS_CONFIG)); ?>;
    const htConfigWrapperId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormWrapperId(DUPX_Params_Manager::PARAM_HTACCESS_CONFIG)); ?>;
    const otConfigInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_OTHER_CONFIG)); ?>;
    const otConfigWrapperId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormWrapperId(DUPX_Params_Manager::PARAM_OTHER_CONFIG)); ?>;
    const archiveEngineInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_ARCHIVE_ENGINE)); ?>;
    const validationShowInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_VALIDATION_SHOW_ALL)); ?>;
    const acceptContinueInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_ACCEPT_TERM_COND)); ?>;
...
$onValidatePrams = array(
    DUPX_Params_Manager::PARAM_CTRL_ACTION => 'ctrl-step1',
    DUPX_Security::CTRL_TOKEN              => DUPX_CSRF::generate('ctrl-step1'),
    DUPX_Params_Manager::PARAM_STEP_ACTION => DUPX_CTRL::ACTION_STEP_ON_VALIDATE
);
?>
...
$switchPrams     = array(
    DUPX_Params_Manager::PARAM_CTRL_ACTION => 'ctrl-step1',
    DUPX_Security::CTRL_TOKEN              => DUPX_CSRF::generate('ctrl-step1'),
    DUPX_Params_Manager::PARAM_STEP_ACTION => DUPX_CTRL::ACTION_STEP_SET_TEMPLATE,
);
?>
            let redirectParam = <?php echo DupProSnapJsonU::wp_json_encode($switchPrams); ?>;
            redirectParam[<?php echo DupProSnapJsonU::wp_json_encode(DUPX_Params_Manager::PARAM_TEMPLATE); ?>] = tplButton.data('template');
