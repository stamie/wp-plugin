...
?>
<script>
    const dbViewModeInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_DB_VIEW_MODE)); ?>;
    const dbHostInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_DB_HOST)); ?>;
    const dbNameInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_DB_NAME)); ?>;
    const dbUserInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_DB_USER)); ?>;
    const dbPassInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_DB_PASS)); ?>;
    const dbActionInputId = <?php echo DupProSnapJsonU::wp_json_encode($paramsManager->getFormItemId(DUPX_Params_Manager::PARAM_DB_ACTION)); ?>;
