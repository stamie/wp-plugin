...
<style>
    ...
    *:focus {
    ...
    #param_item_install-type_4 + .label-checkbox::after,
    #param_item_install-type_5 + .label-checkbox::after,
    #param_item_install-type_6 + .label-checkbox::after,
    #param_item_install-type_7 + .label-checkbox::after
    {
        content: "Beta";
        border-radius:4px; 
        color:#fff; 
