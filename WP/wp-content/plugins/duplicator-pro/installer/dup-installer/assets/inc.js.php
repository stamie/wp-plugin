...
<script>
    ...
    DUPX.GLB_DEBUG = <?php echo $paramsManager->getValue(DUPX_Params_Manager::PARAM_DEBUG) ? 'true' : 'false'; ?>;
...
echo DupProSnapJsonU::wp_json_encode_pprint(array(
    DUPX_Params_Manager::PARAM_ROUTER_ACTION => $paramManager->getValue(DUPX_Params_Manager::PARAM_ROUTER_ACTION),
    DUPX_Security::ROUTER_TOKEN               => DUPX_CSRF::generate($paramManager->getValue(DUPX_Params_Manager::PARAM_ROUTER_ACTION))
));
?>;
