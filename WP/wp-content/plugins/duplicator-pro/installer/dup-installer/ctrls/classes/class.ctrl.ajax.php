    ...
    public static function controller()
    {
        ...
        try {
            ...
            $jsonResult = array(
                ...
                'message'      => $message,
                "errorContent" => array(
                    'pre'  => DUPX_Log::getLogException($e),
                    'html' => ''
                )
            );
        }
    ...
    public static function isAjax(&$action = null)
    {
        ...
        if (is_null($isAjaxAction)) {
            ...
            $argsInput = DupProSnapLibUtil::filterInputRequestArray(array(
                DUPX_Params_Manager::PARAM_CTRL_ACTION => array(
            ...
            if ($argsInput[DUPX_Params_Manager::PARAM_CTRL_ACTION] !== 'ajax' || $argsInput[self::ACTION_NAME] === false) {
