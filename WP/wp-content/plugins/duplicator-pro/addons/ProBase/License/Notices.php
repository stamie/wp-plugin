    ...
    private static function showInvalidSuperNag($daysInvalid)
    {
        ...
        <div class="update-nag dpro-admin-notice dpro-invalid-license">
            ...
            <p>
                ...
                <b>The Good News:</b> You Can Get 10% Off Duplicator Pro Today! 
            </p>
            ...
            <p>
                ...
                - OR - <br/>
                <a target='_blank' href='https://snapcreek.com/duplicator/pricing?discount=SUPERN_10_F2'>Purchase and Get 10% Off!*</a>
            </p>
            <p><small>*Discount appears in cart at checkout time.</small></p>
        </div>
        <?php
    }
