...
<pr>
    To use the below features you must first enable them. These features are at <span style="font-style:italic">beta</span> status - they have worked well in internal testing but are not considered <span style="font-style:italic">release ready</span> at this time. Because of this, ensure you create a site backup or Recovery Point before using.
</pr>
<hr size="1" >
    ...
    <table class="form-table" role="presentation">
        ...
        $templateMng->render(
            ...
            array(
                ...
                'fieldDescription'   => __('Allow importing of standalone and subsites into existing multisite.<br/><span style="font-style: italic">Only available to Business and Gold licenses</span>', 'duplicator-pro')
            )
        );
        ?>
    </table>
    <?php
    $templateData['actions']['save']->getActionNonceFileds();
