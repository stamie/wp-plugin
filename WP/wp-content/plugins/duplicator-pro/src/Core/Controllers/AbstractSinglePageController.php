...
abstract class AbstractSinglePageController implements ControllerInterface
{
    ...
    /**
     * function called on hook init. Can be extended.
     */
    ...
    public function run()
    {
        ...
        $tplMng       = TplMng::getInstance();
        $templateData = apply_filters('duplicator_page_template_data_' . $this->pageSlug, $tplMng->getGlobalData());
        $tplMng->updateGlobalData($templateData);
    ...
    public function isCurrentPage()
    {
        ...
        return (
            isset($levels[ControllersManager::QUERY_STRING_MENU_KEY_L1]) &&
