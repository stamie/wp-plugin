	...
	public function get_error( $error, $context = null, $data = array() ) {
		...
		switch ( $status ) {
			...
			case 403:
				...
				return $error;
			case 404:
				if ( $context === 'register' || $context === 'wupdates-register' ) {
			...
			case 410:
				if ( $context === 'register' || $context === 'latest-version' ) {
			...
			case 423:
				if ( $context === 'register' || $context === 'latest-version' || $context === 'wupdates-latest-version' || $context === 'wupdates' ) {
